...
const Download = () => {
  return (
    <div class=" duration-500 [transform:rotate3d(20_,-10,_1,_60deg)]  hover:-rotate-0 hover:mt-5 group border border-sky-900   overflow-hidden rounded-2xl relative h-[200px] w-[400px] bg-sky-800 p-5 flex flex-col items-start gap-4">
